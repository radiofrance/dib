...
func Test_GenerateRawOutput_FlatDAG(t *testing.T) {
	t.Parallel()
	...
	expected := "digraph images {\n" +
		...
		"  edge[fontsize=10, arrowhead=vee];\n" +
		"\n" +
		"  \"registry.localhost/image1\" [fillcolor=white, style=filled];\n" +
		"  \"registry.localhost/image2\" [fillcolor=red, style=filled];\n" +
		"}\n"
...
func Test_GenerateRawOutput_NestedDAG(t *testing.T) {
	t.Parallel()
