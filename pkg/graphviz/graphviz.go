...
// GenerateGraph generates a graphviz representation of the dag.DAG in the given report.Report rootDir.
func GenerateGraph(dag *dag.DAG, reportRootDir string) error {
	...
	if err := os.WriteFile(graphvizFile, []byte(rawGraphvizOutput), 0o640); err != nil { //nolint:gosec
		return err
	}
