...
```bash
docker build -t europe-west9-docker.pkg.dev/radio-france-dev/registry-test/custome-buildkit:latest .
docker push europe-west9-docker.pkg.dev/radio-france-dev/registry-test/custome-buildkit:latest
```
